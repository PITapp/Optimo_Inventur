    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      ...
      app.UseMvc(builder =>
      {
        if (env.EnvironmentName == "Development")
        {
          ...
          oDataBuilder.EntitySet<OptimoInventur.Models.DbOptimo.VwErfassungNav>("VwErfassungNavs");
          ...
          oDataBuilder.EntitySet<OptimoInventur.Models.DbOptimo.VwInventurErfassungBdo>("VwInventurErfassungBdos");
