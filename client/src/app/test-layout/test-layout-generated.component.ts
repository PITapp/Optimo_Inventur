/*
  ...
  Modify test-layout.component.ts instead.
*/
...
import { MenuComponent } from '@radzen/angular/dist/menu';
...
export class TestLayoutGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  @ViewChild('header0') header0: HeaderComponent;
  @ViewChild('label0') label0: LabelComponent;
  @ViewChild('menu0') menu0: MenuComponent;
