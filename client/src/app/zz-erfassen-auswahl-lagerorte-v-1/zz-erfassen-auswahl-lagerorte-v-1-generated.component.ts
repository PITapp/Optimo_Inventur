/*
  ...
  Modify zz-erfassen-auswahl-lagerorte-v-1.component.ts instead.
*/
...
export class ZzErfassenAuswahlLagerorteV1Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
