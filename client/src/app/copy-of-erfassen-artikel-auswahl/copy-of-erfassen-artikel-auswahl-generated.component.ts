/*
  ...
  Modify copy-of-erfassen-artikel-auswahl.component.ts instead.
*/
...
export class CopyOfErfassenArtikelAuswahlGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
