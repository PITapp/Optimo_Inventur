/*
  ...
  Modify add-inventur-erfassung.component.ts instead.
*/
...
export class AddInventurErfassungGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.dbOptimo.createInventurErfassung(null, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new InventurErfassung!` });
    });
  }
}
