/*
  ...
  Modify zz-erfassen-v-1.component.ts instead.
*/
...
export class ZzErfassenV1Generated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  buttonOpenDialogAuswahlLagerorteClick(event: any) {
    this.dialogService.open(ZzErfassenAuswahlLagerorteV1Component, { parameters: {}, title: `Auswahl Lagerorte` })
